...
<body>
    ...
    <!-- Confirmação do cadastro do entregador -->
    <form action="" class="">
    <div class="rounded-xl justify-self-center mt-13 text-center w-112 h-189 shadow-xl bg-neutral-100 pt-12">
        ...
        <div class="rounded-xl shadow-xl w-90 h-107 justify-self-center mt-25 pt-2">
            ...
            <input type="password" class="justify-self-center w-80 h-12 rounded-xl bg-neutral-100 text-gray-800 pl-2 shadow-2xl" style="font-family: K2D" placeholder="ABC-0000">
    ...
    <!--- Confirmação do cadastro da empresa -->
    <form action="" class="">
    <div class="rounded-xl justify-self-center mt-13 text-center w-112 h-189 shadow-xl bg-neutral-100 pt-12">
        ...
        <div class="rounded-xl shadow-xl w-90 h-87 justify-self-center mt-25 pt-2">

            <h2 style="font-family: K2D" class="text-4xl font-bold mt-4">INFORME O INPJ</h2>

            <p style="font-family: K2D" class="mt-10 flex pl-6 text-lg font-bold">INPJ:</p>
            <input type="email" class="justify-self-center w-80 h-12 rounded-xl bg-neutral-100 text-gray-800 pl-2 shadow-2xl" style="font-family: K2D" placeholder="00.000.000/0000-00">

            <button class="w-40 h-12 border mt-8 rounded-xl bg-neutral-800 text-slate-100 cursor-pointer">CADASTRAR</button>

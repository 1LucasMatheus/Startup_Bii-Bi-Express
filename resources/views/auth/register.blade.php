...
<body>
    ...
    <!-- Cadastro do usuário/entregador -->
    <form action="" class="">
    <div class="rounded-xl justify-self-center mt-13 text-center w-112 h-197 shadow-xl bg-neutral-100 pt-12">
        ...
        <div class="rounded-xl shadow-xl w-90 h-137 justify-self-center mt-4 pt-2">
            ...
            <h2 style="font-family: K2D" class="text-4xl font-bold mt-4">REGISTRAR-SE</h2>
            ...
            <button class="w-40 h-12 border mt-6 rounded-xl bg-neutral-800 text-slate-100 cursor-pointer">CONTINUAR</button>
    ...
    <div class="rounded-xl justify-self-center mt-13 text-center w-112 h-197 shadow-xl bg-neutral-100 pt-12">
        ...
        <div class="rounded-xl shadow-xl w-90 h-117 justify-self-center mt-25 pt-2">
